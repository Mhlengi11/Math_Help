...
public class SimpleA extends JFrame implements ActionListener {
	JPanel redPanel; 
	JLabel label;
	JPanel westPanel;
	JPanel eastPanel;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==answer) {
			try {
				...
				step0 = new BigDecimal(0);
				if(iValue.compareTo(step1)==1||iValue.compareTo(step0)==-1) {
