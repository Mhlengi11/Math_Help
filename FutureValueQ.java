...
public class FutureValueQ extends JFrame implements ActionListener {
	JLabel label1;
	JLabel label2;
	//buttons
	JButton future;
	...
	FutureValueQ(){
		//variables
		future = new JButton("Future value");
		invested = new JButton("monthly instaLlments");
		//rate =new JButton("Intrest rate");
		years = new JButton("number of years");
	
		label1 = new JLabel("MATHS HELP");
		label2 = new JLabel("Choose unknown of A=x[(1+1)^n -1]÷i where F>x");
