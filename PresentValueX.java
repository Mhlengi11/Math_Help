...
public class PresentValueX extends JFrame implements ActionListener {
	JPanel redPanel; 
	JLabel label;
	JPanel westPanel;
	JPanel eastPanel;
	...
	PresentValueX(){
		...
		present = new JLabel("Present value:");
		...
		if(e.getSource()==answer) {
			try {
				...
				if(iValue>1||iValue<0) {
					...
					step3 = 1-step2;
					outcome = (pValue * (iValue/tValue))/ step3;			
					conclusion.setText("accumilated amount is R" + df.format(outcome) + "(using  A=Fi/[1-(1+i)^n]");
