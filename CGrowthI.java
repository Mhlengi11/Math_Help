...
public class CGrowthI extends JFrame implements ActionListener{
	JPanel redPanel; 
	JLabel label;
	JPanel westPanel;
	JPanel eastPanel;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==answer) {
			try {
				...
				outcome = (step4-1)/tValue;
				
				
				conclusion.setText("intrest rate is " + outcome + "(" + outcome*100 +"%, using i=(A÷P)^(1/nxt)-1");
