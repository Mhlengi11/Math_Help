...
public class SimpleI extends JFrame implements ActionListener{
	JPanel redPanel; 
	JLabel label;
	JPanel westPanel;
	JPanel eastPanel;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==answer) {
			try {
				...
				step2 = step3.divide(nValue);

				
				outcome = step1.multiply(step2);
				BigDecimal step4 = new BigDecimal(100);
				BigDecimal step5 = outcome.multiply(step4);
				
				conclusion.setText("intrest rate is " + outcome + "(" + step5 +"%, using i=1/n(A÷P-1))");
