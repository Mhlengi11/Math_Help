...
public class SDecayN extends JFrame implements ActionListener {
	JPanel redPanel; 
	JLabel label;
	JPanel westPanel;
	JPanel eastPanel;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==answer) {
			try {
				...
				step4 = step1.divide(iValue,0);
				
				
				outcome = step4.multiply(step3);
			
				
				conclusion.setText("number of years is " + outcome + "(using i=1/n(1-A÷P))");
