...
public class SDecayI extends JFrame implements ActionListener {
	JPanel redPanel; 
	JLabel label;
	JPanel westPanel;
	JPanel eastPanel;
	...
	SDecayI(){
		...
		c.setVisible(false);
		d.setVisible(false);*/
		header.setText("CALCULATE i OF: A=P(1-in)");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==answer) {
			try {
				...
				step2 = aValue.divide(pValue);
				step3 = step1.subtract(step2);
				step4 = step1.divide(nValue);
				
				
				outcome = step4.multiply(step3);
				step5 = new BigDecimal(100);
				step6 = outcome.multiply(step5);
				
				conclusion.setText("intrest rate is " + outcome + "(" + step6 +"%, using i=1/n(1-A÷P))");
