...
public class PresentValueQ extends JFrame implements ActionListener {
	JLabel label1;
	JLabel label2;
	//buttons
	JButton present;
	...
	PresentValueQ(){
		//variables
		present = new JButton("Present value");
		invested = new JButton("Monthly instalments");
		rate =new JButton("Intrest rate");
		years = new JButton("number of years");
	
		label1 = new JLabel("MATHS HELP");
		label2 = new JLabel("Choose unknown of A=x[1-(1+1)^n]÷i where F>x");
